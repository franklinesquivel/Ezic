...
<head>
    ...
    <script src="../../files/js/s/loadSchedule.js" charset="utf-8"></script>
</head>
<body>
    ...
    <div class="tap-target blue darken-2" data-activates="info">
        <div class="tap-target-content white-text">
            ...
            <p class="white-text">Visualiza el horario que ha sido asignado a tu sección! Puedes descargarlo sí lo necesitas.</p>
        </div>
    </div>
</body>
</html>
