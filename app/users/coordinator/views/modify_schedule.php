...
<head>
    ...
    <script src='../../files/js/c/modifySchedule.js' charset='utf-8'></script>
</head>
<body>
    ...
    <header>
        <nav class="top-nav black">
            <div class="container">
                <div class="nav-wrapper"><a class="page-title">Modificar Horario</a></div>
            </div>
        </nav>
                    ...
                    <li>
                        ...
                        <div class="collapsible-body">
                            <ul>
                                ...
                                <li class="active"><a href="modify_schedule.php" class="waves-effect">Modificar horario<i class="material-icons">assignment_ind</i></a></li>
    ...
    <main>
        <div class="container">
            <div class="row">
                ...
                <div id="teacher_cont" class="col l8 m8 s12 offset-l2 offset-m2"></div>
            </div>
        </div>
    </main>
</body>
