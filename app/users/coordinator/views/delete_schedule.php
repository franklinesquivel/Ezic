...
<head>
    ...
    <script src='../../files/js/c/deleteSchedule.js' charset='utf-8'></script>
</head>
<body>
    ...
    <header>
        <nav class="top-nav black">
            <div class="container">
                <div class="nav-wrapper"><a class="page-title">Eliminar Horarios</a></div>
            </div>
        </nav>
        <div class="container">
        ...
        <ul id="user_nav" class="side-nav fixed">
            ...
            <li class="no-padding">
                <ul class="collapsible collapsible-accordion">
                    <li>
                        <a class="collapsible-header waves-effect active">Horarios<i class="material-icons">schedule</i></a>
                        <div class="collapsible-body">
                            <ul>
                                ...
                                <li class="active"><a href="delete_schedule.php" class="waves-effect">Elminar horario<i class="material-icons">assignment_returned</i></a></li>
                            </ul>
                        </div>
                    </li>
                </ul>
                ...
                <ul class="collapsible collapsible-accordion">
                    <li>
                        ...
                        <div class="collapsible-body">
                            ...
                            <ul>
                                <li><a href="delte_period.php" class="waves-effect">Eliminar<i class="material-icons">delete</i></a></li>
                            </ul>
                            <ul>
    ...
    <main>
        <div class="container">
            <div class="row">
                <br>
                <h3 class="header center black-text">Selecciona un docente</h3>
                <div id="teacher_cont" class="col l8 m8 s12 offset-l2 offset-m2">
    ...
    <div id="confirmModal" class="modal">
        <div class="modal-content">
            <h5 class="center">¿Estás seguro que quieres eliminar el horario?</h5>
        </div>
        <div class="modal-footer">
            <a class="btn-flat btnDelete waves-effect waves-red">Borrar <i class="material-icons right">delete</i></a>
            <a class="btn-flat btnCancel waves-effect waves-light">Cancelar <i class="material-icons right">cancel</i></a> 
        </div>
    </div>
</body>
</html>
