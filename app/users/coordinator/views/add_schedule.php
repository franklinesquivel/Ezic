...
<head>
    ...
    <script src='../../files/js/c/addSchedule.js' charset='utf-8'></script>
</head>
<body>
    ...
    <header>
        <nav class="top-nav black">
            <div class="container">
                <div class="nav-wrapper"><a class="page-title">Agregar Horario</a></div>
            </div>
        </nav>
        <div class="container">
            ...
            <li class="no-padding">
                <ul class="collapsible collapsible-accordion">
                    <li>
                        ...
                        <div class="collapsible-body">
                            <ul>
                                <li class="active"><a href="add_schedule.php" class="waves-effect">Asignar horario<i class="material-icons">assignment</i></a></li>
