...
<head>
    ...
    <script src="../../files/js/c/v_code.js" charset="utf-8"></script>
</head>
<body>
	<header>
                ...
                <ul class="collapsible collapsible-accordion">
                    <li>
                        ...
                        <div class="collapsible-body">
                            ...
                            <ul>
                                <li class="active"><a href="../views/v_code.php" class="waves-effect">Ver<i class="material-icons">visibility</i></a></li>
                            </ul>
                        </div>
                    </li>
                </ul>
    ...
    <main>
        ...
        <div class="tap-target black" data-activates="info">
            <div class="tap-target-content">
                ...
                <p>Acá tienes a tú dispocisión todos los códigos registrados.</p>
            </div>
        </div>
    </main>
</body>
