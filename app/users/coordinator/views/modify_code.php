            ...
            <li class="no-padding">
                <ul class="collapsible collapsible-accordion">
                    <li>
                        ...
                        <div class="collapsible-body">
                            <ul>
                                <li class="active"><a href="add_period.php" class="waves-effect">Añadir<i class="material-icons">library_add</i></a></li>
                            </ul>
                            <ul>
                ...
                <ul class="collapsible collapsible-accordion">
                    <li>
                        ...
                        <div class="collapsible-body">
                            ...
                            <ul>
                                <li class="active"><a href="../views/modify_code.php" class="waves-effect">Modificar<i class="material-icons">edit</i></a></li>
                            </ul>
                            <ul>
