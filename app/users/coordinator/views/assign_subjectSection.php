...
<head>
    ...
    <script src="../../files/js/c/assign_subjectSection.js" charset="utf-8"></script><!-- JS que se alterna -->
</head>
	<body>
		<header>
            <nav class="top-nav black">
                <div class="container">
                    <div class="nav-wrapper"><a class="page-title">Asignar Asignatura</a></div>
                </div>
            </nav>
            <div class="container">
                    ...
                    <ul class="collapsible collapsible-accordion">
                        <li>
                            ...
                            <div class="collapsible-body">
                                ...
                                <ul>
                                    <li class="active"><a href="assign_subjectSection.php" class="waves-effect">Asignar seccionnes<i class="material-icons">format_list_numbered</i></a></li>
                                </ul>
                                <ul>
    	...
    	<main class="show">
    				...
    				<div class="row">
                        ...
                        <div class="input-field col l6 m6 s10 offset-l3 offset-m3 offset-s1">
                            <select id="selectSection" name="selectSection" multiple>
					       	   <option value="" disabled selected>Elegir Secciones</option>
	    					</select>
	    					<label>Nuevas Secciones</label>
                        </div>
    				</div>
    				<div class="row col s12">
    					<div class="btnAssignSubjectSection btn waves-effect waves-light black col l2 m4 s6 offset-l5 offset-m4 offset-s3">Guardar
            ...
            <div class="tap-target black" data-activates="info">
                <div class="tap-target-content">
                    ...
                    <p>Si se te ha olvidado seleccionar una sección al momento de registrar una materia, estas en el apartado correcto; Acá podrás agregar a otras secciones una materia.</p>
                </div>
            </div>
    	</main>
	</body>
