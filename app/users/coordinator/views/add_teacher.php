...
<head>
    ...
    <script src="../../files/js/c/addTeacher.js" charset="utf-8"></script>
</head>
<body>
	<header>
        <nav class="top-nav black">
            <div class="container">
                <div class="nav-wrapper"><a class="page-title">Añadir docente</a></div>
            </div>
        </nav>
    ...
    <div class="tap-target black" data-activates="info">
        <div class="tap-target-content">
            ...
            <p>En este apartado se ingresan todos los datos necesarios para poder registrar a un docente nuevo.</p>
        </div>
    </div>
</body>
</html>