...
<head>
    ...
    <script src="../../files/js/c/addCode.js" charset="utf-8"></script>
</head>
<body>
	<header>
        <nav class="top-nav black">
            <div class="container">
                <div class="nav-wrapper"><a class="page-title">Crear Código</a></div>
            </div>
        </nav>
            ...
            <li class="no-padding">
                <ul class="collapsible collapsible-accordion">
                    <li>
                        ...
                        <div class="collapsible-body">
                            <ul>
                                <li class="active"><a href="../views/add_code.php" class="waves-effect">Añadir<i class="material-icons">library_add</i></a></li>
                            </ul>
                            <ul>
