...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-07-2017 a las 17:54:00
...
--
ALTER TABLE `gnrl_info`
  MODIFY `id_Info` int(15) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `specialty`
  MODIFY `idSpecialty` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
